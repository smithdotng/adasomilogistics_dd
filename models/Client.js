...
const userSchema = new mongoose.Schema({
    ...
    // Client (Patient) specific fields - COMPLETE CLIENT INFO
    clientInfo: {
        nhsNumber: String,
        dateOfBirth: Date,
        gender: String,
...
// Virtual for age (if client)
userSchema.virtual('age').get(function() {
    if (this.role === 'client' && this.clientInfo?.dateOfBirth) {
        const today = new Date();
        const birthDate = new Date(this.clientInfo.dateOfBirth);

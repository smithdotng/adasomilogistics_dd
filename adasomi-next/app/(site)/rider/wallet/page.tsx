...
export default async function RiderWalletPage({
    ...
    const wallet = await Wallet.findOne({ owner: user.id, role: 'rider' }).lean();
    ...
    return (
        <main className="page-shell">
            <div className="container">
                ...
                <p className="section-title mb-1">Rider Wallet</p>
                        ...
                        {transactions.length === 0 ? (
                            ...
                            <div className="table-responsive">
                                <table className="table">
                                    <thead><tr><th>Date</th><th>Type</th><th>Order</th><th>Amount</th><th>Balance After</th></tr></thead>
                                    <tbody>
                                        {transactions.map((t) => {
